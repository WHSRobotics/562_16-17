 ...
 */
public class NewIMU implements I2cPortReadyCallback{
    ...
    public NewIMU(DeviceInterfaceModule deviceInterfaceModule, int physicalPort)
    {
        this.f = physicalPort;
    ...
    public String getDeviceName() {
        return "Adafruit I2C IMU Sensor";
    }
